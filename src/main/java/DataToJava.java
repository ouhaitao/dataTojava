...
import org.dtj.builder.java.*;
import org.dtj.builder.xml.TextNode;
import org.dtj.builder.xml.XmlBuilder;
import org.dtj.builder.xml.XmlNode;
import org.dtj.config.BuildConfig;
import org.dtj.data.TypeMap;
import org.dtj.exception.BuildException;
import org.dtj.util.FileUtil;
import org.dtj.util.LogUtil;
 ...
 */
public final class DataToJava {
    
    private DataToJava() {}
    
    public static void parse(BuildConfig config) {
        new DataToJava().build(config);
    }
